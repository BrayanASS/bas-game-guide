...
export default function Flopados() {
  ...
  useEffect(() => {
    ...
    const jogosFlopados = jogosLocalStorage.filter(
      (jogo) => jogo.status === "Flopado"
    );
    setJogos(jogosFlopados);
  }, []);
  ...
  return (
    <div className="p-10 mx-auto flex flex-col justify-center gap-12">
      ...
      <div className="flex align-middle justify-between items-center">
        <h1 className="text-3xl">Lista de jogos FLOPADOS:</h1>
