...
export default function Jogando() {
  ...
  useEffect(() => {
    ...
    const jogosJogando = jogosLocalStorage.filter(
      (jogo) => jogo.status === "Jogando"
    );
    setJogos(jogosJogando);
  }, []);
  ...
  return (
    <div className="p-10 mx-auto flex flex-col justify-center gap-12">
      ...
      <div className="flex align-middle justify-between items-center">
        <h1 className="text-3xl">Lista de jogos que está JOGANDO:</h1>
