...
export default function Platinados() {
  ...
  useEffect(() => {
    ...
    const jogosPlatinados = jogosLocalStorage.filter(
      (jogo) => jogo.status === "Platinado"
    );
    setJogos(jogosPlatinados);
  }, []);
  ...
  return (
    <div className="p-10 mx-auto flex flex-col justify-center gap-12">
      ...
      <div className="flex align-middle justify-between items-center">
        <h1 className="text-3xl">Lista de jogos PLATINADOS:</h1>
