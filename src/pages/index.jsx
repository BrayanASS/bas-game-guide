...
export default function AllItems() {
  ...
  const adicionado = () => toast("Jogo adicionado com sucesso!");
  const excluido = () => toast("Jogo excluido com sucesso!");
  const modificado = () => toast("Jogo modificado com sucesso!");
  const editado = () => toast("Jogo editado com sucesso!");
  ...
  const toggleModoEdicao = (jogoId) => {
    setEditandoJogoId(jogoId === editandoJogoId ? null : jogoId);
  };

  const handleEditar = (jogoId) => {
    const jogoEditado = jogos.find((jogo) => jogo.id === jogoId);
    if (jogoEditado) {
      ...
      setEditandoJogoId(null); // Desativar o modo de edição
    }
    editado();
  };

  const handleExcluir = (jogoId) => {
  ...
  return (
    <div className="px-10 mx-auto flex flex-col justify-center gap-12">
            ...
            <div className="grid gap-4 py-4">
              <div className="grid grid-cols-4 items-center gap-4">
                ...
                >
                  ...
                  <option defaultValue value="Jogando">
                    Jogando
                  </option>
                  ...
                  <Dialog>
                    <div className="flex align-middle gap-3 justify-end">
                      <DialogTrigger>
                        <Icon
                          ...
                          onClick={() => {
                            toggleModoEdicao(jogo.id);
                            // Preencher os campos de edição com os valores atuais do jogo
                    ...
                    <DialogContent className="sm:max-w-[425px]">
                      ...
                      <div className="grid gap-4 py-4">
                        ...
                        <DialogFooter>
                          <Button onClick={() => handleEditar(jogo.id)}>
                            Salvar Alterações
                          </Button>
                        </DialogFooter>
                      </div>
